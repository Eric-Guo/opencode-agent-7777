...
| Timeline projection and rendering               | `src/pages/session/timeline/model.ts`, `src/pages/session/timeline/projection.ts`, `src/pages/session/timeline/rows.ts`, `src/pages/session/timeline/timeline-row.ts`, `src/pages/session/timeline/row-reconciliation.ts`, `src/pages/session/timeline/message-timeline.tsx`, `src/pages/session/timeline/summary-diffs.ts`                                                                                                                                                                                                                                                                                    | `src/pages/session/use-session-hash-scroll-to-end.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Grouped assistant-part construction, projection, reconciliation, context-tool grouping, copy targeting, and thinking/error rows now follow the main app. The compact renderer still omits routing, paging, virtualization, measurement, comment cards, and the full expandable summary-diff UI.                                                                                                 |
