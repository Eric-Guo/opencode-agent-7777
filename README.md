...
- `src/components/prompt-input-v2.tsx` remains a compact wrapper over the shared PromptInputV2. Prompt draft state lives
  in `src/context/prompt-state.ts`, while `src/context/prompt.ts` exposes the single active instance.
